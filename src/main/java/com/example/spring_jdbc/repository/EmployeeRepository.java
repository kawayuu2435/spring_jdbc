...
public class EmployeeRepository {
    ...
    public Employee load(Integer id) {
        ...
        // System.out.println("Repositoryのnullが呼ばれた");
        return employee;
    }

    public List<Employee> findAll() {
        // System.out.println("RepositoryのfindAllが呼ばれた");
        String sql = """
                SELECT id,name,age,gender,department_id FROM employees ORDER BY id
                """;
    ...
    public Employee save(Employee employee) {
        ...
        if(employee.getId()==null){
            String insertSql
            ="INSERT INTO employees(name,age,gender,department_id)"+"VALUES(:name,:age,:gender,:departmentId)";
